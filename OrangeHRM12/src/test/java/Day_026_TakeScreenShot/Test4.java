...
public class Test4 {
	...
	// FileUtils.copyFile(scrFile, new File("C:\\ScreenShot1.jpg"));
	 ...
	 FileUtils.copyFile(SrcFile1, new File("C:\\TC028_Login\\TC1_ScreenShot1.jpg"));
