...
public class subha_dataprovider {
	...
	//if u want to execute u r test with multiple input test data , we can user Data Provider
		...
		//step1
		 @DataProvider(name = "subha1")
		  public static Object[][] Test1() throws Exception {
		 
		        return new Object[][] { 
		        	{ "https://opensource-demo.orangehrmlive.com/","Admin", "admin123","Indians122" },
		        	{ "https://opensource-demo.orangehrmlive.com/","Admin", "admin123","Indians123" }
		        	};
		  }
		 
		 @Test(dataProvider = "subha1") //step2 u r test will be connected to dataProvider 
