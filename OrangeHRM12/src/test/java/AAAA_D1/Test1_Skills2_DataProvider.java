...
public class Test1_Skills2_DataProvider {
	...
	public static Object[][] Authentication1TC01_Add_Nationality() throws Exception {
		...
		Object[][] testObjArray = eat.getTableArray("C://HTML Report//OrangeHRM6//TC01Skills.xlsx", "Sheet4");
  ...
  public void SkillsTest(String TestURL,String UserName,String Password,String SkillName,String SkillDescr ) throws Exception {
	  ...
	  Test1_Skills2_DataProvider T1= new Test1_Skills2_DataProvider();
