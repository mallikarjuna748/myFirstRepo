...
public class TC01_Login_DataProvider2 {
	...
	public void loginTest(String TestURL,String UserName,String Password,String Nationality_text) throws Exception
	{
		TC01_Login_DataProvider2.OpenChromeBroswer();
		TC01_Login_DataProvider2.OpenOrangeHRM(TestURL);
		TC01_Login_DataProvider2.Login(UserName,Password); //step2
		TC01_Login_DataProvider2.AddNationalities(Nationality_text);//stp2
		TC01_Login_DataProvider2.CloseBrowser();
	}
